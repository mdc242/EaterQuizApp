...
//  EaterQuiz
//
//  Created by Chase, Meadow D on 2/28/24.
//
...
class ViewController: UIViewController {
    ...
    @IBAction func selectTacos(_ sender: Any) {
    ...
    @IBAction func selectHamburger(_ sender: Any) {
    ...
    @IBAction func selectBroccoli(_ sender: Any) {
